                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <Button className="social-gradient text-white font-medium px-6">
                        Опубликовать
                      </Button>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex space-x-6">
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          className={`flex items-center space-x-2 ${post.isLiked ? 'text-red-500' : 'text-slate-600 hover:text-red-500'}`}
                        >
                        ...
                        <Button variant="ghost" size="sm" className="flex items-center space-x-2 text-slate-600 hover:text-green-500">
